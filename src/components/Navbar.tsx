...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-4 pt-5 pointer-events-none flex flex-col items-center">
      <header className="pointer-events-auto bg-[#fdfbf7]/85 backdrop-blur-xl border border-zinc-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-full px-6 py-3 flex items-center justify-between w-full max-w-3xl transition-all duration-300">
        {/* Logo */}
        <Link 
          href="/" 
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center gap-5 text-[14px] font-semibold text-zinc-600">
        ...
        <button
          ...
          aria-label="메뉴 열기"
          className="md:hidden p-1.5 text-zinc-700 hover:text-[#c55232] rounded-full hover:bg-zinc-100 transition-colors flex items-center justify-center"
        >
      ...
      {isOpen && (
        <div className="pointer-events-auto sm:hidden w-full max-w-sm mt-2 p-5 bg-[#fdfbf7]/95 backdrop-blur-2xl border border-zinc-200/80 shadow-[0_16px_40px_rgba(0,0,0,0.08)] rounded-3xl animate-in fade-in slide-in-from-top-3 duration-200">

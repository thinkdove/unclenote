...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon.ico?v=bulb-transparent", sizes: "any" },
      { url: "/icon.png?v=bulb-transparent", sizes: "512x512", type: "image/png" },
    ],
    apple: [
      { url: "/apple-icon.png?v=bulb-transparent", sizes: "180x180", type: "image/png" },
    ],
  },
  robots: {
    index: true,
            ...
            <div className="site-footer-main">
              <div className="site-footer-brand">
                <Link href="/" className="site-footer-logo" aria-label="삼촌노트 홈">
                  <Image src="/images/brand-avatar-bulb-transparent.png" alt="" width={32} height={32} />
                  <span>삼촌노트</span>
                </Link>
